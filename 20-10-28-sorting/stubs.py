...
print("")
#list2 tests
print("list1 unsorted: " + list_to_str(list2))
print("list1 sorted: " + list_to_str(sorted(list2)))
...
print("")
#list3 tests
print("list1 unsorted: " + list_to_str(list3))
print("list1 sorted: " + list_to_str(sorted(list3)))
